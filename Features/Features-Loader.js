var features = [["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Blade Runner 2049","a"],["Loki","r"],["Blade Runner 2049","a"],["Loki","r"],["Loki","r"],["Loki","r"],["Blade Runner 2049","a"],["Loki","r"],["Loki","r"],["Loki","r"],["Blade Runner 2049","a"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Loki","r"],["Blade Runner 2049","a"]];
...
function load_synopsis_wide(r_or_a=null) {
  if (!document.getElementById("wide-synopses").hasChildNodes()) {
    ...
    $("#wide").load("Features/"+features[synopsis_pointer][0].replace(" ","%20")+"/Synopsis%20Wide.html");
    synopsis_pointer += 1;
  }
}
